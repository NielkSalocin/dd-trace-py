...
# threading.Semaphore, threading.BoundedSemaphore, and threading.Condition are Python classes.
LockTypeInst = Union[
...
class TestThreadingConditionCollector(BaseThreadingLockCollectorTest):
    ...
    Inherits all profiling tests from BaseThreadingLockCollectorTest.
    No Condition-specific tests needed since wait/notify/notify_all pass through
    via __getattr__ and don't involve our profiling wrapper.
    """
